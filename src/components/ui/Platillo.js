    ...
    <div className="w-full px-3 mb-4">
        ...
        <div className="lg:flex">
            <div className="lg:w-5/12 xl:w-3/12">
                <img src={imagen} alt="Aquí se supone que va la imagen del platillo" />
                <div className="sm:flex sm:-mx-2 pl-2">
                    <label className="block mt-5 sm:w-2/4">
                        <span className="block text-gray-800 mb-2">Existencia</span>
                        <select
                         className="shadow appearance-none border rounded w-full py-2 px-3 leading-tigh focus:outline-none focus:shadow-outline bg-white"
                         value={existencia}
                         ref={existenciaRef}
